...
existed_data = {}
try:
    f = open('ManualTransFile_tr_prog.json', encoding='utf8')
    ...
    while True:
        ...
        while True:
            try:
                ...
                # 1.0 14b
                cur_result = translate_v10(cur_key, api_url=endpoint, max_tokens=cur_key.__len__() * 2)
                if end_with_splash:
                    cur_key += '\\'
                    cur_result += '\\'
                break
                ...
                # continue
                skipped = True
                skipped_list.append(cur_key)
                break
        if skipped:
            print("T#" + str(thread_id) + " Skipped: " + cur_key)
            continue
        # save to result
        wlock.acquire()
        ...
        if save_progress and cur_idx % 200 == 0:
            ...
            with open('ManualTransFile_tr_prog.json', 'w', encoding='utf8') as f4:
...
if skipped_count == 0:
    ...
    with open('sp.json', 'w', encoding='utf8') as f3:
