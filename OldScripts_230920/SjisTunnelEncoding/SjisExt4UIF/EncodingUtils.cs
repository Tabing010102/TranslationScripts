...
namespace Yuka.Util
{
    public class EncodingUtils
    {
        ...
        public static readonly ShiftJisTunnelEncoding ShiftJisTunnelEncoding = new ShiftJisTunnelEncoding();
        ...
        public static void SetSjisMappingTable(string path)
        {
            Encoding.RegisterProvider(CodePagesEncodingProvider.Instance);
            ShiftJisTunnelEncoding.SetMappingTable(File.ReadAllBytes(path));
        }
    ...
    public class ShiftJisTunnelEncoding : Encoding
    {
        ...
        public Dictionary<char, char> Mappings { get => _mappings; }
